			...
			if ( _mode == "translate" ) {
				...
				if ( scope.space == "local" ) {
					...
					if ( scope.axis == "XYZ") {
						...
						scale = 1 + ( ( point.y ) / (50/scope.speed) );
						...
						if ( scope.axis == "X" ) scope.object.scale.x = oldScale.x * ( 1 + point.x / (50/scope.speed) );
						if ( scope.axis == "Y" ) scope.object.scale.y = oldScale.y * ( 1 + point.y / (50/scope.speed) );
						if ( scope.axis == "Z" ) scope.object.scale.z = oldScale.z * ( 1 + point.z / (50/scope.speed) );
